        ...
        <tr>
            ...
            <td>${this.status}</td>
              ...
              if(this.status=="Pending"){         
                    var buttons= ` <td>
                    <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent accept-button" data-userid = ${this.user_id} data-value=${this.device_id}  data-device=${this.type +" " +this.brand +" " + this.model}>Accept </button>
                    <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored reject-button" data-notificationid = ${this.notification_id}  data-device=${this.type +" " +this.brand +" " + this.model}>Reject </button>
            </td>
        </tr>`;
              }
              else{
