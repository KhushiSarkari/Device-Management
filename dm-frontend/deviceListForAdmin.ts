    ...
    device_id: number;
        ...
        getDeviceList(token: number) {
            ...
            <tr>
                ...
                const buttons =  `<button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" style="margin-top: 10px;" id="add-button" ><span class="material-icons">add</span>
                   Add Device  </button>`;
